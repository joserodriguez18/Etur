<!-- Header -->
<?php
include("../includes/subcategoriainc.php");
    ...
    <section class="categorias">
        <div class="container-fluid">
            <div class="band">
                ...
                ?>
                    <a href="subcategoria.php?categoria=<?php echo $subcategoria['categoria']; ?>&subcategoria=<?php echo $subcategoria['subcategoria']; ?>" class="">
                        <h1>
