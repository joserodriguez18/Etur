    ...
    <main>
        ...
        <section class="parallax">
            <div class="parallax__background" style="--image-url: url(../img/cursos/obesidad.jpg)"></div>
            <div class="parallax__overlay"></div>
            <div class="parallax__content">
                <div class="container margin-top-100 margin-bottom-100">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>Curso Introducción al mundo del sobrepeso y la obesidad.</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container position-relative" id="content">
            <div class="row h-100 ">
                ...
                <aside class="col-md-3 bg-light padding-top-70" id="left">
