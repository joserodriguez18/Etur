            ...
            <div class="parallax__content">
                <div class="container margin-top-100 margin-bottom-100">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>
                                La IA elimina mágicamente los objetos en movimiento de los videos.
                            </h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="post-content-body">
                            ...
                            <div class="row mb-5 mt-5">
                                <div class="col-md-12 mb-4">
                                    <img src="../../img/main-banner/2.jpg" alt="Image placeholder" class="img-fluid rounded">
                                </div>
                                <div class="col-md-6 mb-4">
                                    <img src="../../img/main-banner/3.jpg" alt="Image placeholder" class="img-fluid rounded">
                                </div>
                                <div class="col-md-6 mb-4">
                                    <img src="../../img/main-banner/4.jpg" alt="Image placeholder" class="img-fluid rounded">
                                </div>
                            </div>
-->
                    ...
                    <div class="col-md-12 col-lg-4 sidebar">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="ultimas-tab" data-toggle="tab" href="#ultimas" role="tab" aria-controls="ultimas" aria-selected="false">Últimas</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="popular" role="tabpanel" aria-labelledby="popular-tab">
                                <div class="post-entry-sidebar">
                                    <ul>
                                        <li>
                                            <a href="">
                                                <img src="../../img/cursos/1.jpg" alt="Image placeholder" class="mr-4">
                                                <div class="text">
                                                    <h4>La IA elimina mágicamente los objetos en movimiento de los videos.</h4>
                                                    <div class="post-meta">
                                                        <span class="mr-2">Septiembre 12, 2020 </span>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <img src="../../img/cursos/2.jpg" alt="Image placeholder" class="mr-4">
                                                <div class="text">
                                                    <h4>La IA elimina mágicamente los objetos en movimiento de los videos.</h4>
                                                    <div class="post-meta">
                                                        <span class="mr-2">Septiembre 12, 2020 </span>
                                        ...
                                        <li>
                                            <a href="">
                                                <img src="../../img/cursos/3.jpg" alt="Image placeholder" class="mr-4">
                                                <div class="text">
                                                    <h4>La IA elimina mágicamente los objetos en movimiento de los videos.</h4>
                                                    <div class="post-meta">
                                                        <span class="mr-2">Septiembre 12, 2020 </span>
                            ...
                            <div class="tab-pane fade" id="ultimas" role="tabpanel" aria-labelledby="ultimas-tab">
                                <div class="post-entry-sidebar">
                                    <ul>
                                        <li>
                                            <a href="">
